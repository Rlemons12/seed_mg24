...
`LIVE` continuously samples, processes, and publishes configured telemetry. It is temporary and automatically returns to `LOW_POWER` after the gateway's bounded live-mode interval.
