...
arduino-cli compile --fqbn SiliconLabs:silabs:xiao_mg24:protocol_stack=ble_silabs --libraries "$package_dir/firmware/libraries" --build-path "$package_dir/build" --build-property "compiler.cpp.extra_flags=$flags" "$package_dir/firmware/xiao_mg24_sensor_node"
